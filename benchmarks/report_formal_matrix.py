...
def decode_profile(summary):
    ...
    return {
        ...
        "delta_plan_median_ms": median(values("block_table_delta_plan_cpu_ms")),
        "packed_row_pack_median_ms": median(values("packed_row_pack_cpu_ms")),
        "packed_h2d_submit_median_ms": median(values("packed_h2d_submit_cpu_ms")),
